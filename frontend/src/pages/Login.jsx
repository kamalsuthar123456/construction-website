...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, HardHat, Building2, Wrench, CheckCircle2, XCircle } from "lucide-react";
...
export default function AuthPage() {
  ...
  const [rememberMe, setRememberMe] = useState(false); // ✅ Login checkbox state
  const [acceptTerms, setAcceptTerms] = useState(false); // ✅ NEW: Register checkbox state
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ NEW: Login validation - Check "Remember me"
    if (isLogin) {
      if(!rememberMe) {
    ...
    // ✅ NEW: Register validation - Check "Terms & Conditions"
    if (!isLogin) {
      if(!acceptTerms) {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            className="fixed top-8 left-1/2 -translate-x-1/2 z-50 min-w-[320px] max-w-md"
          >
            <div
              className={`flex items-center gap-4 px-6 py-4 rounded-2xl shadow-2xl backdrop-blur-md ${
                toast.type === "success"
      ...
      {/* Left Panel - Construction Theme Gradient */}
        ...
        <div className="relative z-10 flex flex-col justify-center px-8 md:px-10 lg:px-16 py-12 text-white">
          ...
          >
            <div className="flex items-center gap-3 mb-6 lg:mb-10">
              ...
              <span className="font-display text-xl lg:text-2xl font-bold tracking-tight">BuildPro</span>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12 lg:px-16 bg-white relative min-h-screen md:min-h-0">
        ...
        <div className="w-full max-w-sm sm:max-w-md relative z-10">
          ...
          <div className="md:hidden flex items-center gap-3 mb-8">
            ...
            <span className="font-display text-xl font-bold tracking-tight text-gray-900">BuildPro</span>
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full h-12 sm:h-14 text-sm sm:text-base font-bold group bg-orange-500 hover:bg-orange-600 text-white rounded-lg sm:rounded-xl shadow-lg shadow-orange-500/30 hover:shadow-xl hover:shadow-orange-500/40 transition-all duration-300"
